        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                Text('Live Quizzes',style: GoogleFonts.rubik(fontSize: 16,fontWeight: FontWeight.bold),),
                Text('View All',style:  GoogleFonts.rubik(fontSize: 14,fontWeight: FontWeight.bold,color: const Color(0xFF6A5AE0)),)
              ],
            ),
